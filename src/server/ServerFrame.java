...
public class ServerFrame extends JFrame {
	...
	public ServerFrame() {
		...
		URL urlServer = ServerFrame.class.getResource("/image/serverManager.png");
		Image img1 = Toolkit.getDefaultToolkit().createImage(urlServer);
		setIconImage(img1);
...
//Title---------------------------------
		JLabel lblNewLabel = new JLabel("SERVER CHAT");
