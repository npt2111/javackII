...
//			printWriter.close();
	...
	public MainFrame() throws Exception {
		...
		URL urlChat = MainFrame.class.getResource("/image/chat.png");
		...
		JLabel lblNewLabel_1 = new JLabel("Hi "+ nameUser);
		...
		panel.setBorder(new TitledBorder(new CompoundBorder(null, UIManager.getBorder("CheckBoxMenuItem.border")),
				"Danh sách online", TitledBorder.LEADING, TitledBorder.TOP, null,
				new Color(0, 0, 0)));
		...
		btnSaveServer.setBackground(Color.GREEN);
