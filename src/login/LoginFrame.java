...
public class LoginFrame extends JFrame implements ActionListener {
	private static String NAME_FAILED = "Tên chứa ký tự không hợp lệ! Vui lòng thử lại.";
	private static String NAME_EXSIST = "Tên đã được sử dụng! Vui lòng thủ lại.";
	private static String SERVER_NOT_START = "Khởi động Server trước khi bắt đầu!";
	...
	public LoginFrame() {
		setTitle("Login");
		URL urlLogin = LoginFrame.class.getResource("/image/login.png");
		Image img1 = Toolkit.getDefaultToolkit().createImage(urlLogin);
		setIconImage(img1);
		...
		btnConnectServer.setFont(new Font("Tahma", Font.BOLD, 18));
		btnConnectServer.setBackground(Color.green);
